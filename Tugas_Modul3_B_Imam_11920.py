...
st.markdown("""
    <div class="center">
        <img src="https://media.tenor.com/oqJo9GcbfjYAAAAi/welcome-image-server.gif" alt="Welcome Image">
    </div>
    """, unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1920</h1>", unsafe_allow_html=True)
...
uploaded_file = st.sidebar.file.uploader("Upload dile dataset_regresi_IPK.csv", type=["csv"])

if uploaded_file is not None:
    input_data = pd.read_csv(uploaded_file)
    st.write("<h3 style='text-align: center; color: #0073e^;'>Data yang diupload:</h3>", unsafe_allow_html=True)
    st.dataframe(input_data)

   model_directory = r'C:\Users\Muhammad Imam\Desktop\Model Suprevised Learning (Praktek)\Tugas3_B_11920' 
   ...
   if os.patch.exists(model_path):
    with open(model_path, 'rb') as f:
       ...
       mtk2 = st.sidebar.number_input("Nilai Matematika Semester 1.2", 60.0, 100.0)
        ...
        st.error("Model tidak ditemukan, silahkan cek file model di direktori. ")st.sidebar.subheader("Masukan Nilai")
        mtk1 = st.sidebar.number_input("Nilai Matematika Semester 1.1", 60.0, 100.0)
        mtk2 = st.sidebar.number_input("Nilai Matematika Semester 1.2", 60.0, 100.0)
        mtk3 = st.sidebar.number_input("Nilai Matematika Semester 2.1", 68.0, 100.0)
        mtk4 = st.sidebar.number_input("Nilai Matematika Semester 2.2", 66.0, 100.0)
